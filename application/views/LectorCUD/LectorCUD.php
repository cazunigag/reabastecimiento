    ...
    <section class="content">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"><i class="fa fa-gear"/>  Toolbar</i></h3>
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-lg-1 col-xs-2">
              <a class="btn btn-app" id="importarEX">
            ...
            <div class="col-xs-12">
              <table class="table table-hover">
                <tr style="font-size: 40px; ">
                    <th style="text-align: center;">ID TRANSPORTE</th>
...
<script src="<?php echo base_url();?>assets/js/LectorCUD/LectorCUD.js?n=6"></script>
<!-- Bootstrap 3.3.7 -->
