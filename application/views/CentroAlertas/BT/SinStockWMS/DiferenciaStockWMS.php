...
<head>
  ...
  <title>Diferencia Stock BT-WMS</title>
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-table"/> Skus Diferencia Stock WMS</i></h3>
            ...
            <div id="POPUP_Detalle_Sku" class="grid">
              <div id="toolbarDetalle"></div>
              <div id="gridDetalleSku"></div>
            </div>
            <!-- /.box-body -->
          </div>
        </div>
...
<script type="text/javascript" src="<?php echo base_url();?>assets/js/CentroAlertas/BT/SinStockWMS/sinstockwms.js?n=6"></script>
<style type="text/css">
  a{
    color: white;
  }
