...
<head>
  ...
  <title>Aseguramiento de Calidad</title>
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="box box-widget widget-user-2">
            ...
            <a href="<?php echo site_url('aseguramientoCalidad/recepcion'); ?>">
              <div class="widget-user-header bg-olive" id="boxWMS">
                <div class="widget-user-image">
                  <img class="img-circle" src="<?php echo base_url();?>assets/img/recepcion.png" alt="User Avatar">
                </div>
                <!-- /.widget-user-image -->
                <h3 class="widget-user-username">Recepcion</h3>
                <br>
              </div>
            </a>
          </div>
        ...
        <div class="col-md-3">
          ...
          <div class="box box-widget widget-user-2">
            ...
            <a href="<?php echo site_url('alertas/bt'); ?>">
              <div class="widget-user-header bg-olive" id="boxBT">
                <div class="widget-user-image">
                  <img class="img-circle" src="<?php echo base_url();?>assets/img/bigticket.png" alt="User Avatar">
                </div>
                <!-- /.widget-user-image -->
                <h3 class="widget-user-username">Despacho</h3>
                <br>
              </div>
            </a>
          </div>
        ...
        <div class="col-md-3">
          ...
          <div class="box box-widget widget-user-2">
            ...
            <a href="<?php echo site_url('alertas/pmm'); ?>">
              <div class="widget-user-header bg-olive" id="boxPMM">
                <div class="widget-user-image">
                  <img class="img-circle" src="<?php echo base_url();?>assets/img/movimientosinv.png" alt="User Avatar">
                </div>
                <!-- /.widget-user-image -->
                <h3 class="widget-user-username">Movimientos Inventario</h3>
              </div>
            </a>
          </div>
          <!-- /.widget-user -->
