...
<head>
  ...
  <title>Errores Recepcion ASN</title>
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-table"/> ASN Recibidos con Error</i></h3>
            ...
            <div id="POPUP_Detalle_Interfaz" class="grid">
              <div id="gridDetalleInterfaz"></div>
            </div>
            <!-- /.box-body -->
          </div>
        </div>
...
<script type="text/javascript" src="<?php echo base_url();?>assets/js/AseguramientoCalidad/Recepcion/recepcion.js?n=1"></script>
<style type="text/css">
  a{
    color: white;
  }
