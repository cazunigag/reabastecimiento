            ...
            <div class="box-header with-border">
              ...
              <div class="box-tools">
                <div class="input-group input-group-sm" style="width: 150px;">
                  <input type="text" name="txtsubl" id="txtsubl" class="form-control pull-right" placeholder="Sublinea">

                  <div class="input-group-btn">
                    <button type="submit" class="btn btn-primary" id="btnBuscarSublinea"><i class="fa fa-search"></i></button>
                  </div>
                </div>
              </div>
...
<script type="text/javascript" src="<?php echo base_url();?>assets/js/Reabastecimiento/Mantenedores/sublineas.js?n=3" async>
</script>
<style type="text/css">
  a{
    color: white;
