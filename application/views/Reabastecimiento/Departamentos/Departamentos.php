          ...
          <div class="col-md-4">
            <div class="box box-primary collapsed-box">
              <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-cube"></i> Departamentos</h3>
                ...
                <div class="row">
                  <div class="col-md-10">
                    <div class="form-group">
                      ...
                      <select id="selectDepto" class="form-control select2" data-placeholder="Seleccione..." style="width: 100%;">
                        <option>Seleccione... </option>
                        <?php foreach ($deptos as $key) { ?>
                          <option value="<?php echo $key->CODE_ID; ?>"><?php echo $key->CODE_ID." - ".$key->CODE_DESC; ?></option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-primary">
            <div id="toolbarsubl"></div>
            <div id="gridPutwyType"></div>
          </div>
        </div>
      </div>
...
<script type="text/javascript" src="<?php echo base_url();?>assets/js/Reabastecimiento/Departamentos/departamentos.js?n=1"></script>
<style type="text/css">
