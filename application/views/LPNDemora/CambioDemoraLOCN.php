...
<head>
  ...
  <title>Cambio Demora Ubicacion</title>
...
<script type="text/javascript" src="<?php echo base_url();?>assets/js/LPNDemora/cambiodemoralocn.js?n=2"></script>
<style type="text/css">
  .k-toolbar .k-button{
    color: black;
  }
